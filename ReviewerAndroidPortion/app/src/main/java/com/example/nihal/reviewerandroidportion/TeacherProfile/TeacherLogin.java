        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              /*  if(!TeacherRegister.isValidEmailAddress(user))
                ...
                HttpRequest request = new HttpRequest("http://10.100.173.39:8084/DataBase-Hibernate/LoginServlet?"+"tag=login"+"&userType=teacher"+"&userName="+user+"&password="+pass+"&device=android",REQUEST_LOGIN,TeacherLogin.this);
